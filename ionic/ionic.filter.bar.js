    ...
    angular.module('jett.ionic.filter.bar')
      ...
      function ($timeout, $ionicGesture, $ionicPlatform) {
                ...
                if ($ionicPlatform.is('android')) {
                    filterBarTemplate =
                        '<div ng-controller="SearchCtrl" class="filter-bar-wrapper filter-bar-light filter-bar-transition-filter-bar-in">' +
                        ...
                        '<input type="search" class="filter-bar-search" ng-model="shareData.search" ng-model-options="{debounce: 300 }" placeholder="Search..." />' +
                    ...
                    filterBarTemplate =
                        ...
                        '</label>' +
                        '<button class="filter-bar-cancel button button-clear" id="clearBtn">Cancel</button>' +
                        '</div>' +
                        '</div>';
                }
